Attribute VB_Name = "basShot"
      ...
      Public Function CaptureScreen2(x As Long, y As Long, width As Long, height As Long) As Picture
         #If Win32 Then
            Dim hWndScreen As Long
         #ElseIf Win16 Then
            Dim hWndScreen As Integer
         ...
         Set CaptureScreen2 = CaptureWindow(hWndScreen, False, x, y, _
